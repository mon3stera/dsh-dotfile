...
export function guidanceText() {
	return [
		...
		"2. Prefer desktop_tree as the structured view: it gives each widget's role, name, text, and desktop-global pixel extents, which desktop_mouse accepts directly. Use `app`/`focused` filters to keep it small.",
		...
		"4. desktop_mouse acts on desktop-global logical pixels. desktop_tree extents need no conversion; screenshot pixels need the stated scale mapping.",
