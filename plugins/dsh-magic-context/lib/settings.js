...
export const CONTEXT_SETTINGS_DEFAULTS = {
	...
	compartmentBudgetRatio: 0.15,
	exactTokens: true,
	tokenizerFile: "deepseek.json",
	dreamerProvider: "",
	dreamerModel: "",
...
export const ContextSettingsSchema = z.object({
	...
	dreamerMode: z.string().default(CONTEXT_SETTINGS_DEFAULTS.dreamerMode),
	...
	compartmentBudgetRatio: z.number().min(0).max(1).default(CONTEXT_SETTINGS_DEFAULTS.compartmentBudgetRatio),
	exactTokens: z.boolean().default(CONTEXT_SETTINGS_DEFAULTS.exactTokens),
	tokenizerFile: z.string().default(CONTEXT_SETTINGS_DEFAULTS.tokenizerFile),
